...
Measuring research software impact is hard. Software often gets mentioned without formal citation, or used programmatically without any mention at all. These challenges have been explored by [Afiaz et al. (2024)](https://pubmed.ncbi.nlm.nih.gov/39067017/) and [Istrate et al. (2022)](https://arxiv.org/abs/2209.00693). The former was funded by NCI's [Informatics Technology for Cancer Research](https://www.cancer.gov/about-nci/organization/cssi/research/itcr) program; the latter, from the [Chan Zuckerberg Initiative](https://chanzuckerberg.com/), created the CZI Software Mentions dataset which links text mentions in papers to software entities. Inspired by these efforts, we wanted to explore more deeply for one software tool *how* it is used based on published literature. In this experiment we look at [cBioPortal](https://www.cbioportal.org), the tool our team works on—classifying which cancer types, analysis methods, and data sources researchers work with.

As a user-facing website for accessing cancer genomics data, cBioPortal has been cited many times, providing a unique opportunity to analyze usage patterns. This goes beyond conventional tracking via Google Analytics or Heap, and aims to paint a clearer picture of how researchers use software tools.
